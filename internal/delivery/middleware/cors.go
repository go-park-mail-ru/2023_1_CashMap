...
func CORS() gin.HandlerFunc {
	...
	corsConfig.AllowHeaders = []string{"Content-Type", "Origin", "X-Csrf-Token", "Access-Control-Expose-Headers"}
	...
	corsConfig.ExposeHeaders = []string{"Access-Control-Expose-Headers"}
