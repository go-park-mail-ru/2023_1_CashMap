...
func (storage *CSRFStorage) SaveCSRFToken(csrf *authorization_ms.CSRF, expirationTime int) error {
...
func (storage *CSRFStorage) CheckCSRFToken(csrf *authorization_ms.CSRF) (bool, error) {
...
func (storage *CSRFStorage) DeleteCSRFToken(csrf *authorization_ms.CSRF) error {
